...
- [2. Visiting the web](#2-visiting-the-web)
- [3. Attempting SSH login](#3-attempting-ssh-login)
- [4. dirb reconeisance](#4-dirb-reconeisance)
- [5. WPScan reconeisance](#5-wpscan-reconeisance)
- [6. Prepairing the exploit](#6-prepairing-the-exploit)
- [7. Using the exploit](#7-using-the-exploit)
- [8. Getting the SSH Key](#8-getting-the-ssh-key)
- [9. First user flag](#9-first-user-flag)
- [10. Changing Users](#10-changing-users)
- [11. Second user flag](#11-second-user-flag)
- [12. Escalating to root](#12-escalating-to-root)
- [13. Third flag](#13-third-flag)
